...
# USER GREETING
print('\nThank you for choosing Bryan\'s Tip-Top Check Splitter!')
...
while True:
  ...
  if input('Would you like to calculate another bill? (enter Y or N) ') in yes_list:
    continue
  print('Ok, thank you for using Bryan\'s Tip-Top Check Splitter!\n')
  break
